...
$additional = [
    'sport-fitness' => [
        ...
        ['madfit.ig', ['fitness', 'workouts', 'dance fitness'], 'Créatrice anglophone centrée sur les entraînements à domicile.', $sources['sport'], 'approved', 'US'],
    ...
    'food-cooking' => [
        ['fastgoodcuisine', ['recettes', 'food entertainment', 'cuisine maison'], 'Créateur français produisant des recettes et formats food très visuels.', $sources['food'], 'approved', 'FR'],
        ...
        ['marmiton_org', ['recettes', 'cuisine maison', 'astuces'], 'Compte éditorial de recettes et d’idées de cuisine du quotidien.', $sources['food'], 'approved', 'FR'],
    ],
    'personal-branding' => [
        ...
        ['gregisenberg', ['startup', 'création de contenu', 'community'], 'Entrepreneur anglophone partageant idées, communautés et construction de produits.', $sources['branding'], 'approved', 'US'],
        ['aliabdaal', ['productivité', 'création de contenu', 'education'], 'Créateur et entrepreneur partageant méthodes de travail et systèmes de contenu.', $sources['branding'], 'approved', 'GB'],
        ...
        ['sahilbloom', ['personal branding', 'business', 'storytelling'], 'Créateur et entrepreneur publiant des idées structurées sur le travail et la croissance.', $sources['branding'], 'approved', 'US'],
        ['moooookaaa_', ['création de contenu', 'direction créative', 'streetwear'], 'Créateur français qui documente ses idées créatives, ses projets et sa construction de marque.', 'https://www.modash.io/find-influencers/france/paris/micro', 'approved', 'FR'],
        ['watch.gabe', ['b-roll', 'photographie', 'vidéographie'], 'Photographe et créateur américain qui enseigne le storytelling visuel, le b-roll et la création de contenu.', 'https://watchgabe.com/', 'approved', 'US'],
        ['40shotit', ['vidéographie', 'direction artistique', 'création de contenu'], 'Créateur américain orienté image, vidéo et production de contenus visuels pour les marques.', 'https://linktr.ee/40shotit', 'approved', 'US'],
        ['theianchristianson', ['personal branding', 'coaching', 'création de contenu'], 'Créateur anglophone qui partage la construction d’une marque personnelle et la monétisation d’une audience.', 'https://www.nedwagner.com/', 'approved', 'US'],
        ['kienobifilms', ['création de contenu', 'stratégie vidéo', 'personal branding'], 'Créateur et opérateur de contenu qui explique les hooks, le montage et les systèmes de croissance par la vidéo.', 'https://kienobi.com/', 'approved', 'US'],
    ],
    'tech-ai' => [
        ...
        ['mkbhd', ['consumer tech', 'smartphones', 'product reviews'], 'Créateur américain spécialisé dans les produits et usages technologiques.', $sources['tech'], 'approved', 'US'],
        ['ijustine', ['consumer tech', 'gadgets', 'product reviews'], 'Créatrice américaine publiant des tests et expériences autour de la tech grand public.', $sources['tech'], 'approved', 'US'],
        ['mrwhosetheboss', ['consumer tech', 'smartphones', 'product reviews'], 'Créateur britannique spécialisé dans les tests de produits et innovations tech.', $sources['tech'], 'approved', 'GB'],
        ['yourchatgptguide', ['ai tools', 'productivity', 'artificial intelligence'], 'Créateur anglophone expliquant les outils et usages pratiques de l’IA.', $sources['tech'], 'approved', 'US'],
    ],
    'wellness' => [
        ['jayshetty', ['mental wellness', 'mindfulness', 'relationships'], 'Auteur et créateur partageant des contenus de réflexion et de bien-être mental.', $sources['wellness'], 'approved', 'US'],
        ['melissawoodhealth', ['wellness', 'movement', 'mindfulness'], 'Créatrice américaine autour du mouvement doux et des routines de bien-être.', $sources['wellness'], 'approved', 'US'],
        ['hubermanlab', ['neuroscience', 'sleep', 'mental wellness'], 'Compte pédagogique autour des mécanismes du cerveau, du sommeil et des habitudes.', $sources['wellness'], 'approved', 'US'],
        ['the.holistic.psychologist', ['mental health', 'self-awareness', 'relationships'], 'Psychologue et créatrice autour de la santé mentale et de la connaissance de soi.', $sources['wellness'], 'approved', 'US'],
        ['headspace', ['meditation', 'mindfulness', 'sleep'], 'Compte de référence autour de la méditation guidée et du sommeil.', $sources['wellness'], 'approved', 'US'],
    ],
    'events' => [
        ['mindyweiss', ['event planning', 'weddings', 'party design'], 'Consultante américaine reconnue pour ses événements et mariages haut de gamme.', $sources['events'], 'approved', 'US'],
        ['toddevents', ['event planning', 'party design', 'weddings'], 'Équipe événementielle partageant concepts, scénographies et coulisses de célébrations.', $sources['events'], 'approved', 'US'],
        ['sarahhaywoodweddings', ['weddings', 'event design', 'luxury events'], 'Wedding planner britannique spécialisée dans la conception de mariages et événements premium.', $sources['events'], 'approved', 'GB'],
        ['colincowie', ['event design', 'weddings', 'luxury events'], 'Designer et producteur d’événements internationaux.', $sources['events'], 'approved', 'US'],
        ...
        ['eventuresinc', ['event planning', 'corporate events', 'experiential marketing'], 'Agence événementielle partageant des concepts et réalisations expérientielles.', $sources['events'], 'approved', 'US'],
        ...
        ['weddingchicks', ['weddings', 'event planning', 'bridal design'], 'Publication spécialisée dans les idées, outils et inspirations de mariage.', $sources['events'], 'approved', 'US'],
    ],
    'languages' => [
        ...
        ['learnfrenchwithalexa', ['french learning', 'grammar', 'vocabulary'], 'Professeure et créatrice anglophone dédiée à l’apprentissage du français.', $sources['languages'], 'approved', 'GB'],
        ...
        ['englishwithlucy', ['english learning', 'pronunciation', 'vocabulary'], 'Créatrice britannique spécialisée dans l’anglais et la prononciation.', $sources['languages'], 'approved', 'GB'],
        ...
        ['street_french', ['french learning', 'conversation', 'expressions'], 'Créateur anglophone enseignant le français parlé et les expressions du quotidien.', $sources['languages'], 'approved', 'US'],
    ],
    'lifestyle' => [
        ...
        ['muchelleb', ['habits', 'self-development', 'productivity'], 'Créatrice australienne partageant des méthodes de changement d’habitudes et d’organisation.', $sources['lifestyle'], 'approved', 'US'],
        ['lavendaire', ['self-development', 'journaling', 'lifestyle'], 'Créatrice américaine autour du journaling, de l’identité et du développement personnel.', $sources['lifestyle'], 'approved', 'US'],
        ...
        ['jamesclear', ['habits', 'self-development', 'productivity'], 'Auteur partageant des cadres pratiques autour des habitudes et du comportement.', $sources['lifestyle'], 'approved', 'US'],
        ['sarahs_day', ['routine', 'wellness', 'lifestyle'], 'Créatrice australienne partageant routines, mouvement et quotidien.', $sources['lifestyle'], 'approved', 'US'],
        ...
        ['thesorrygirls', ['home', 'diy', 'lifestyle'], 'Créatrices partageant projets maison, décoration et transformations accessibles.', $sources['lifestyle'], 'approved', 'US'],
    ...
    'local-culture' => [
        ...
        ['parismusees', ['paris', 'museums', 'culture'], 'Réseau de musées parisiens partageant œuvres, expositions et patrimoine.', $sources['local-culture'], 'approved', 'FR'],
        ['quefaireaparis', ['paris', 'local discovery', 'events'], 'Compte culturel proposant des idées de sorties et découvertes à Paris.', $sources['local-culture'], 'approved', 'FR'],
        ['livinglondonhistory', ['london', 'local history', 'architecture'], 'Créateur britannique racontant l’histoire et les détails cachés de Londres.', $sources['local-culture'], 'approved', 'GB'],
        ['bowlofchalk', ['london', 'local history', 'city guides'], 'Créateur britannique partageant anecdotes et visites thématiques de Londres.', $sources['local-culture'], 'approved', 'GB'],
        ['samaspeaks_', ['london', 'food', 'local discovery'], 'Créatrice londonienne explorant les cultures, lieux et histoires de la ville.', $sources['local-culture'], 'approved', 'GB'],
        ...
        ['secret_nyc', ['new york', 'local discovery', 'culture'], 'Publication locale partageant lieux, expériences et histoires de New York.', $sources['local-culture'], 'approved', 'US'],
        ['parisjetaime', ['paris', 'tourism', 'culture'], 'Office de tourisme partageant patrimoine, culture et expériences parisiennes.', $sources['local-culture'], 'approved', 'FR'],
    ...
    'travel' => [
        ['brunomaltor', ['travel', 'adventure', 'travel tips'], 'Créateur français partageant voyages, conseils pratiques et découvertes.', $sources['travel'], 'approved', 'FR'],
        ['lostleblanc', ['travel', 'filmmaking', 'adventure'], 'Créateur américain spécialisé dans les récits et images de voyage.', $sources['travel'], 'approved', 'US'],
        ...
        ['drewbinsky', ['travel', 'culture', 'local discovery'], 'Créateur américain explorant destinations, cultures et histoires locales.', $sources['travel'], 'approved', 'US'],
        ...
        ['thebucketlistfamily', ['family travel', 'adventure', 'travel'], 'Famille de créateurs racontant des voyages et aventures internationales.', $sources['travel'], 'approved', 'US'],
        ...
        ['candaceabroad', ['travel', 'city guides', 'travel tips'], 'Créatrice britannique partageant des guides de villes et conseils de voyage.', $sources['travel'], 'approved', 'GB'],
        ['framedbytheworld', ['travel', 'photography', 'adventure'], 'Créateur partageant des récits visuels et expériences de voyage.', $sources['travel'], 'approved', 'US'],
        ['finduslost', ['travel', 'photography', 'destinations'], 'Couple de créateurs produisant des guides et récits visuels de destinations.', $sources['travel'], 'approved', 'US'],
    ],
    'startup' => [
        ...
        ['danmartell', ['saas', 'founders', 'productivity'], 'Entrepreneur et investisseur partageant des cadres pratiques pour les fondateurs.', $sources['startup'], 'approved', 'US'],
        ...
        ['tinawells', ['entrepreneurship', 'founders', 'career'], 'Entrepreneure et auteure partageant carrière, création et développement de projets.', $sources['startup'], 'approved', 'US'],
        ['rajshamani', ['entrepreneurship', 'founders', 'business'], 'Entrepreneur et animateur partageant conversations et apprentissages business.', $sources['startup'], 'approved', 'US'],
    ],
    'business' => [
        ...
        ['shanhanif', ['business', 'entrepreneuriat', 'creator economy'], 'Entrepreneur britannique qui partage des systèmes de croissance, de vente et de développement de business.', 'https://www.shanhanif.com/', 'approved', 'GB'],
        ['theo.le.lion', ['entrepreneuriat', 'marketing', 'personal branding'], 'Entrepreneur français qui documente la croissance d’une agence, le marketing et la performance personnelle.', 'https://linktr.ee/theo.lion', 'pending', 'FR'],
        ...
        ['marketingharry', ['marketing', 'personal branding', 'content creation'], 'Créateur britannique spécialisé dans le marketing et la croissance par le contenu.', $sources['business'], 'approved', 'GB'],
        ...
        ['lewishowes', ['business', 'entrepreneurship', 'interviews'], 'Entrepreneur et animateur partageant conversations et apprentissages professionnels.', $sources['business'], 'approved', 'US'],
        ['garyvee', ['marketing', 'entrepreneurship', 'business'], 'Entrepreneur et créateur autour du marketing, des médias et de la croissance.', $sources['business'], 'approved', 'US'],
    ],
];
