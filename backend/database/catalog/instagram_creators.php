...
$additional = [
    ...
    'personal-branding' => [
        ...
        ['moooookaaa_', ['création de contenu', 'direction créative', 'streetwear'], 'Créateur français qui documente ses idées créatives, ses projets et sa construction de marque.', 'https://www.modash.io/find-influencers/france/paris/micro', 'pending', 'FR'],
        ['watch.gabe', ['b-roll', 'photographie', 'vidéographie'], 'Photographe et créateur américain qui enseigne le storytelling visuel, le b-roll et la création de contenu.', 'https://watchgabe.com/', 'pending', 'US'],
        ['40shotit', ['vidéographie', 'direction artistique', 'création de contenu'], 'Créateur américain orienté image, vidéo et production de contenus visuels pour les marques.', 'https://linktr.ee/40shotit', 'pending', 'US'],
        ['theianchristianson', ['personal branding', 'coaching', 'création de contenu'], 'Créateur anglophone qui partage la construction d’une marque personnelle et la monétisation d’une audience.', 'https://www.nedwagner.com/', 'pending', 'US'],
        ['kienobifilms', ['création de contenu', 'stratégie vidéo', 'personal branding'], 'Créateur et opérateur de contenu qui explique les hooks, le montage et les systèmes de croissance par la vidéo.', 'https://kienobi.com/', 'pending', 'US'],
    ],
    'tech-ai' => [
    ...
    'business' => [
        ...
        ['shanhanif', ['business', 'entrepreneuriat', 'creator economy'], 'Entrepreneur britannique qui partage des systèmes de croissance, de vente et de développement de business.', 'https://www.shanhanif.com/', 'pending', 'GB'],
